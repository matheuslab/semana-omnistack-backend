...
module.exports = {
    async create(request, response) {
        ...
        const user = {
            ...
            // apiKey: {  || 'SomeUserLoginName', || 'Some user password', apiKey: 'Some API Sid' },
        ...
        const auth_token = sign(user, 'dQDuDcjwIc83NQTbxIpw');
        const readmeUrl = 'https://some-freaking-test.readme.io/';
